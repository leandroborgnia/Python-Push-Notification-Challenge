...
<!-- SPECKIT START -->
Active feature: **005-web-frontend-console**. For technologies, project structure, shell commands,
and other important context, read the current plan: `specs/005-web-frontend-console/plan.md` (with

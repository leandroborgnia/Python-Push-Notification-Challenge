...
<!-- SPECKIT START -->
Active feature: **004-admin-stats-report**. For technologies, project structure, shell commands,
and other important context, read the current plan: `specs/004-admin-stats-report/plan.md` (with
